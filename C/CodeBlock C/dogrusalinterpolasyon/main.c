...
/*
    ...
    fonksiyonunun  [0, 2] araligindaki kok degerini 8*10^-4 hata siniri içinde dogrusal interpolasyon metodu kullanarak hesaplayiniz.
    Durma Kosulu: |xn - xn-1 |< Hata

*/

//F(x) fonksiyonun koda donusturulmus hali
...
//fonksiyonumuz sonucunun isaretini (+,-) hesaplayan kodumuz
...
int main()
{
    ...
    while(fabs(hesaplanan_hata) >= hata){
        //Dogrusal interpolasyondaki Xn'i matematiksel hesaplama isleminin koda donusturulmus hali
